...
{
    [CustomEntity("FlavorsHelper/CustomBounceBlock")]
    [Tracked]
    public class CustomBounceBlock : Solid
    {
		...
		public CustomBounceBlock(Vector2 position, float width, float height)
		...
		public CustomBounceBlock(EntityData data, Vector2 offset)
